...
export const ScoreBug = React.memo(function ScoreBug(): React.JSX.Element {
  return (
    ...
    >
      ...
      <span className="text-[9px] uppercase tracking-wider text-red-500 mr-0.5">LIVE</span>
      ...
      <span className="flex items-center gap-1">
        <span
          ...
          style={{ background: "linear-gradient(90deg, #3c3b6e 40%, #ffffff 40%, #b22234 40%)" }}
          aria-hidden="true"
        >
          US
        </span>
      ...
      {/* Score */}
      <span className="font-mono text-xs text-[var(--brand-gold)] px-0.5">2 — 1</span>
      ...
      <span className="flex items-center gap-1">
        ...
        <span
          className="w-3.5 h-2.5 inline-flex items-center justify-center text-[7px] text-white font-black rounded-xs select-none"
          style={{ background: "linear-gradient(90deg, #006847 33%, #ffffff 33%, #ffffff 66%, #c8102e 66%)" }}
          aria-hidden="true"
        >
          MX
        </span>
